...
bool Quadrotor::setCommand(const Command &cmd) {
  ...
  if (std::isfinite(cmd_.collective_thrust)) {
    const Scalar collective_thrust_min =
      dynamics_.collective_thrust_min() / dynamics_.getMass();
    const Scalar collective_thrust_max =
      dynamics_.collective_thrust_max() / dynamics_.getMass();
    cmd_.collective_thrust =
      std::clamp(cmd_.collective_thrust, collective_thrust_min,
